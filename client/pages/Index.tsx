  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 bg-white">
        ...
        <section
          ref={mailingListAnimation.ref}
          id="mailing-list"
          className={`py-12 md:py-16 lg:py-20 px-4 md:px-8 lg:px-16 xl:px-32 bg-white animate-fade-in-up ${
            mailingListAnimation.isVisible ? "visible" : ""
          }`}
        >
          <div className="max-w-5xl mx-auto">
            {/* Section Title */}
        ...
        {/* Order Now Section */}
        <section
          ref={orderNowAnimation.ref}
          id="order-now"
          className={`py-12 md:py-16 lg:py-20 px-4 md:px-8 lg:px-16 xl:px-32 bg-white animate-fade-in-up ${
            orderNowAnimation.isVisible ? "visible" : ""
          }`}
        >
          <div className="max-w-5xl mx-auto">
            {/* Section Title */}
        ...
        <section
          ref={contentWarningAnimation.ref}
          id="content-warning"
          className={`py-12 md:py-16 lg:py-20 px-4 md:px-8 lg:px-16 xl:px-32 bg-white animate-fade-in-up ${
            contentWarningAnimation.isVisible ? "visible" : ""
          }`}
        >
          <div className="max-w-5xl mx-auto">
            {/* Section Title */}
        ...
        {/* Audiobook Section */}
        <section
          ref={audiobookAnimation.ref}
          id="audiobook"
          className={`py-12 md:py-16 lg:py-20 px-4 md:px-8 lg:px-16 xl:px-32 bg-white animate-fade-in-up ${
            audiobookAnimation.isVisible ? "visible" : ""
          }`}
        >
          <div className="max-w-5xl mx-auto">
            {/* Section Title */}
